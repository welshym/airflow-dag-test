#
# No infras deprovisioning task failure DAG
#
...
with DAG(
        dag_id="no_deprovision_infras-dag",
    ...
    # Simulate provisioning infras, running compliance tests, running ETL jobs and then skipping deprovisioning the infras (failure)
    ProvisionTask >> ComplianceTask >> t0 >> t1 >> t2 >> t3