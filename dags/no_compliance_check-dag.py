#
# No compliance checking task failure DAG
#
...
with DAG(
        dag_id="no_compliance_check-dag",
    ...
    # Simulate provisioning infras, skipping running compliance tests , running ETL jobs and then deprovisioning the infras
    ProvisionTask >> t0 >> t1 >> t2 >> t3 >> DeProvisionTask